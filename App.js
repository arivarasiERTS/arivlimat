      ...
      <View style={styles.container}>
        ...
        <View style={styles.controls}>
          <TouchableOpacity style={styles.control} onPress={this.handlePreviousTrack}>
            <Ionicons name='caret-back' size={48} color='#444' />
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.control} onPress={this.handleNextTrack}>
            <Ionicons name='caret-forward' size={48} color='#444' />
            <Ionicons name='' size={48} color='#444' />
          </TouchableOpacity>
        </View>
        {this.renderFileInfo()}
      </View>
...
export default function App() {
  ...
  async function playSound() {
    ...
    const { sound } = await Audio.Sound.createAsync( require('./assets/terevaaste.mp3')
    );
    setSound(sound);
